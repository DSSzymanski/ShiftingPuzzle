...
def heuristic(puzzle):
    #base case
    if puzzle.puzzle_check() == True: return puzzle
    ...
    curr_heuristic = get_heuristic(puzzle.get_puzzle_state())
        ...
        for i in range(3):
            for j in range(3):
                ...
                for move in p_moves:
                    ...
                    new_heuristic = get_heuristic(new_puzzle.get_puzzle_state())
                    ...
                    heuristic
                    """
                    if new_heuristic <= curr_heuristic and str(new_puzzle.get_puzzle_state()) not in found_states:
